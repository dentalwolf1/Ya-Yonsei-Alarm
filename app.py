...
# ---------------------------------------------------------------------------
# Phone number memory — stores {kakao_user_id: phone_number}
# Persists in memory while server is running.
# ---------------------------------------------------------------------------
user_phone_book: dict[str, str] = {}
...
# Without phone (returning user): 06/10/14:30 "title"
...
def webhook():
    ...
    if no_phone:
        if user_id not in user_phone_book:
