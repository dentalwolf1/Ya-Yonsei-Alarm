...
def send_push_message(user_id: str, text: str) -> None:
    """
    Send a push notification to a user via Kakao i Open Builder
    bot message API. user_id comes from userRequest.user.id.
    This fires automatically at alarm time with no user action needed.
    """
    url = "https://kapi.kakao.com/v1/api/talk/bot/message/send"
    headers = {
